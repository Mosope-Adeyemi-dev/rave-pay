<template>
    <div class="whole-container">
                ...
                <form>
                    ...
                    <div class="input-box">
                        ...
                        <select class="services">
                                <option v-for="service in offeredServices" :key="service" :value="service"> {{service}} </option>
                            </select>
                    </div>
                </form>
            </div>
        ...
        <div class="call-to-action">
            ...
            <input v-if="!isLoading" type="submit" class="default-btn" value="REGISTER" :disabled="email == '' || password == ''" @click="login()">
